...
import design.pattern.study.behavioral.observer.exam01.Button.OnClickListener;
...
// 이렇게 정의해서 쓰기보다는 OnClickListener 인터페이스가 함수형 인터페이스이므로 그냥 익명함수로 생성자처럼 바로 사용
